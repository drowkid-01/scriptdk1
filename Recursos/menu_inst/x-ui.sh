...
show_usage() {
    echo "x-ui Cómo usar scripts de administración (Traduccion @drowkid01)"
    echo "------------------------------------------"
...
————————————————
 ...
 "
   ...
   echo -ne "\e[1;33mSeleccione su opción: [0-14] "&&read num
    ...
    case "${num}" in
        ...
        14) install_bbr
        ;;
        *) echo -e "\e[1;30m[\e[1;31m!\e[1;30m] elige una opción entre [0-14] únicamente \e[1;30m[\e[1;31m!\e[1;30m]${plain}"
        ;;
    esac
}
